...
const evtListeners = {
  "onscrollView1$scrolltolower": [
  ...
  ], "onicon6$tap": [
    {
      ...
      argsBinds: {
        'params.0.params.state': ($comp, lists, forItems, event, $context, $w) => {
          const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
  ...
  ], "oncontainer25$tap": [
    {
      ...
      argsBinds: {
        'params.0.data': ($comp, lists, forItems, event, $context, $w) => {
          const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
...
`
  ...
  ], "onicon1$tap": [
    {
      ...
      handler: function ({ event, $w, params }) {
        const $comp = $w.$comp; return (
          ({ event }) => {
            $comp.dataset.state.chatRecords = $w.container22.data.llmConfig ? [] : [$comp.dataset.state.chatRecords[0]]
          }
        )({ event })
      },
      args: {
...
const dataBinds = {
  container22: {
    'data': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
  ...
  menuLayout1: {
    'style': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
        {
  ...
  scrollView1: {
    'scrollTop': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
  ...
  image1: {
    'src': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
  ...
  text1: {
    'text': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
  ...
  container18: {
    '_waDisplay': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
        $w.container22.data.llmConfig
  ...
  icon7: {
    ...
    }, '_waIf': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
  ...
  text7: {
    'text': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
        `我是 ${$w.container22.data.llmConfig.model}，很高兴见到你！`
      )
    }
  },
  repeater1: {
  ...
  repeater1_item: {
    '_waFor': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
        $comp.dataset.state.chatRecords
      )
    }
  ...
  container13: {
    'classList': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
        concatClassList(
  ...
  icon6: {
    'name': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
  ...
  markdown1: {
    'options': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
        {
    ...
    }, 'value': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
        $w.item_listView1.content
      )
    }, '_waIf': ($comp, lists, forItems, event, $context, $w) => {
  ...
  card1: {
    'showContent': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
  ...
  unifiedLink1: {
    ...
    }, 'url': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
    ...
    '_waDisplay': ($comp, lists, forItems, event, $context, $w) => {
      ...
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
        ((display) => {
          ...
          }; if (!display) { style.display = "none" }; return style
        })((() => {
          const $for = forItems; const $index = lists?.[0]?.currentIndex;
          return (
            !!$w.container22.data.llmConfig.reasonModel
          )
        })())
  ...
  rating1: {
    ...
    }, 'callbacks.tooltip': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
        props => {
  ...
  tagSelect1: {
    'range': ($comp, lists, forItems, event, $context, $w) => {
      const $for = forItems; const $index = lists?.[0]?.currentIndex; return (
